...
| [aave](./skills/aave/SKILL.md)                               | Manage Aave V3 positions (Supply, Borrow, Repay) on Base | DeFi Management |
| [balance](./skills/balance/SKILL.md)                         | Check ETH and token balances on supported chains         | Wallet Data     |
...
# Optional:
export PRIVATE_KEY="your-wallet-private-key" # For direct signing if not using Privy
```
